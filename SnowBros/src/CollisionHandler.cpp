...
Side_t CollisionHandler::checkCollision(Entity* other)
{
	...
	if(other->getPosX() + other->getDim()->x > entity->getPosX() && other->getPosX() + other->getDim()->x < entity->getPosX() + entity->getDim()->x && ((other->getPosY() + other->getDim()->y > entity->getPosY() && other->getPosY() < entity->getPosY() + entity->getDim()->y)))
		{ /*std::cout << "side_left" << std::endl << std::flush;*/ return SIDE_LEFT; }
	if(entity->getPosX() + entity->getDim()->x > other->getPosX() && entity->getPosX() + entity->getDim()->x < other->getPosX() + other->getDim()->x && ((other->getPosY() + other->getDim()->y > entity->getPosY() && other->getPosY() < entity->getPosY() + entity->getDim()->y)))
